package com.hhovhann.gamemanagement.exception.handler;

import com.hhovhann.gamemanagement.exception.model.ErrorResponse;
import com.hhovhann.gamemanagement.exception.GameNotFoundException;
import com.hhovhann.gamemanagement.exception.GamerNotFoundException;
import com.hhovhann.gamemanagement.exception.GameValidationException;
import com.hhovhann.gamemanagement.exception.GamerValidationException;
...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(value = {GameValidationException.class, GamerValidationException.class})
    ...
    @ExceptionHandler(value = {GameNotFoundException.class, GamerNotFoundException.class})
